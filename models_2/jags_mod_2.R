...
jas_data <- readRDS("data_bees_all.499_1994.2010.rds")

# output files
rdataFile=paste0("Model_outputs/bee.B.all_C.",i,"_run",".rdata")
save.dir="/gws/nopw/j04/ceh_generic/arrgre/sumRQenv/bee.B.all"
...
base <- list(temp.m=covars$mean_temp,temp.a=covars$temp_anom,RQsum=covars$RQsum)
add <- list(list(semi=covars_id$semi,urban=covars_id$urban),
            list(semi=covars_id$semi,urban=covars_id$urban,agri=covars_id$agri),
            list(agri=covars_id$agri))
