...
jas_data <- readRDS("data_ladybirds_all.499_1994.2016.rds")
...
base <-list(list(temp.m=covars$mean_temp,temp.a=covars$temp_anom,RQApo=covars$RQsum_Apol,RQMpo=covars$RQsum_Mpol,RQApr=covars$RQsum_Apre,RQMpr=covars$RQsum_Mpre),
            list(temp.m=covars$mean_temp,temp.a=covars$temp_anom,semi=covars$semi,RQApo=covars$RQsum_Apol,RQMpo=covars$RQsum_Mpol,RQApr=covars$RQsum_Apre,RQMpr=covars$RQsum_Mpre),
            list(temp.m=covars$mean_temp,temp.a=covars$temp_anom,semi=covars$semi,agri=covars$agri,RQApo=covars$RQsum_Apol,RQMpo=covars$RQsum_Mpol,RQApr=covars$RQsum_Apre,RQMpr=covars$RQsum_Mpre))
