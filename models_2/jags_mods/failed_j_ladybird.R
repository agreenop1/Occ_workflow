...
base <-list(list(temp.m=covars$mean_temp,temp.a=covars$temp_anom,semi=covars$semi,RQapol=covars$RQsum_A_pol,
                 RQmpol=covars$RQsum_M_pol,
                 RQapre=covars$RQsum_A_pre,
                 RQmpre=covars$RQsum_M_pre),
            list(temp.m=covars$mean_temp,temp.a=covars$temp_anom,semi=covars$semi,agri=covars$agri,RQapol=covars$RQsum_A_pol,
                 RQmpol=covars$RQsum_M_pol,
                 RQapre=covars$RQsum_A_pre,
                 RQmpre=covars$RQsum_M_pre))
...
source("Occ_workflow_V1/jags_rjags_func_2.1.R")
