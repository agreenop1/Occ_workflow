...
# temperature cov
temperature<- env_cov$mean_temp
temperature.<- env_cov$temp_anom
temperature$temperature.m <- temperature$mean.x
temperature$mean.x <- NULL
temperature <- left_join(temperature,temperature.)
temperature$temperature <- temperature$temperature.m+temperature$mean.x 
